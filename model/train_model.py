...
এই script টা একবার চালান → model/ ফোল্ডারে pkl ফাইল তৈরি হবে
...
# ── 1. Load Dataset ───────────────────────────────────────────
print("\n[1/6] Loading dataset...")
# train_model.py model/ ফোল্ডারে আছে, data/ ফোল্ডার একধাপ উপরে
DATA_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "heart_2020_cleaned.csv")
...
# model/ ফোল্ডারে save করবে (script যেখানে আছে)
...
print(f"\n  Next steps:")
print(f"    Local:  uvicorn api.index:app --reload")
print(f"    Deploy: git push → Vercel auto-deploy")
print("=" * 65)